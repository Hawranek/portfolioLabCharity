...
<section class="form--steps">
    ...
    <div class="form--steps-container">
        ...
        <form:form modelAttribute="donation" action="/donation/form" method="post" name="donation">
            ...
            <div data-step="1" class="active">
                ...
                <c:forEach items="${categories}" var="item">
                    <div class="form-group form-group--checkbox">
                        <label>
                            <form:checkbox path="categories" value="${item}"/>
            ...
            <div data-step="2">
                ...
                <div class="form-group form-group--inline">
                    <label>
                        Liczba 60l worków:
                        <form:input path="quantity" type="number" begin="1" step="1" min="1" id="quantity"/>
                    </label>
                </div>
            ...
            <div data-step="3">
                ...
                <c:forEach items="${institutions}" var="item">
                    <div class="form-group form-group--checkbox">
                        <label>
                            <form:radiobutton path="institution" value="${item}"/>
            ...
            <div data-step="4">
                ...
                <form:errors path="pickUpTime" cssClass="error"/><br/>
                <form:errors path="pickUpDate" cssClass="error"/><br/>
                ...
                <div class="form-section form-section--columns">
                    ...
                    <div class="form-section--column">
                        ...
                        <div class="form-group form-group--inline">
                            <label> Godzina <form:input path="pickUpTime" type="time" id="pickUpTime"/>
                        </div>
